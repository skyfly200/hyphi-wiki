...
Reference guide for wiring WS2812B addressable LEDs — the LED type used in all Gloflora products.
...
For Gloflora Home (30 LEDs) at full brightness, inject power at LED 15.
...
For Gloflora (short runs ≤30 LEDs), the 3.3V signal without a level shifter is reliable in practice.

## WS2812B vs SK6812

Gloflora uses WS2812B. SK6812 is a common alternative with similar pinout but adds a white channel (RGBW). WLED supports both — select the correct LED type in [WLED Config](../firmware/wled-config).
