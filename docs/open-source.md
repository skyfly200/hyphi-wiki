...
The **Open Wireless Lighting Standard** is fully open. The specification — services, UUIDs, wire formats, mesh topology — is published here and free to implement on any hardware.
...
| Thing | Status |
|---|---|
| OWLS protocol spec | Open — implement freely |
| Hyphi Hub source code | Open source |
| Hyphi name | Reserved trademark |
| Hyphi logo | Reserved trademark |
| Glowflora hardware designs | See individual product pages |
